...
pub struct AppConfig {
    ...
    /// Admin authentication token settings.
    pub auth: AuthConfig,
    ...
    fn default() -> Self {
        Self {
            ...
            config_sync: aster_forge_config::ConfigSyncConfig {
                ...
                endpoint: String::new(),
                topic: "beacon_cast.config_reload".to_string(),
            },
...
/// Static admin authentication settings.
#[derive(Debug, Clone, serde::Deserialize, serde::Serialize)]
#[serde(default)]
pub struct AuthConfig {
    /// JWT signing secret. Must be replaced for deployment.
    pub jwt_secret: String,
    /// Whether admin session cookies require HTTPS.
    pub cookie_secure: bool,
    /// Extra trusted frontend origins allowed to perform cookie-authenticated admin writes.
...
impl Default for AuthConfig {
    fn default() -> Self {
        Self {
            jwt_secret: "change-me-beacon-cast-development-secret".to_string(),
            cookie_secure: false,
...
impl Default for DatabaseConfig {
    fn default() -> Self {
        Self {
            url: "sqlite://beacon_cast.db?mode=rwc".to_string(),
            pool_size: 10,
            retry_count: 3,
        }
    }
