...
mod m20260701_000002_beacon_cast_product_schema;
mod m20260702_000003_activity_usage_spans;
mod m20260702_000004_activity_classification_config;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            Box::new(m20260627_000001_forge_foundation_schema::Migration),
            Box::new(m20260701_000002_beacon_cast_product_schema::Migration),
            Box::new(m20260702_000003_activity_usage_spans::Migration),
            Box::new(m20260702_000004_activity_classification_config::Migration),
        ]
    }
}
